...
import ReportUserLayout from "~/pages/admin/reports/report-user/ReportUserLayout";
  ...
  return (
    <Routes>
      ...
      >
        ...
        >
          <Route path={ReportPath.RESOLVED} element={<ReportUser />} />
          <Route path={ReportPath.UNRESOLVED} element={<ReportUser />} />
        </Route>
