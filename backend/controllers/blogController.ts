...
export const checkBlogOwnership = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const formatUpdateData = (req: Request, res: Response, next: NextFunction) => {
        const updateField: any = {};

        if (req.body.status == 'public' && (req as any).user.role !== 'teacher') {
